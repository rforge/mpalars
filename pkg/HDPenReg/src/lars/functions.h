 ...
 */
STK::Array2DVector< std::pair<int,STK::Real> > computeCoefficients(HD::PathState const& state1,HD::PathState const& state2,std::pair<int,int> const& evolution, STK::Real const& lambda);
