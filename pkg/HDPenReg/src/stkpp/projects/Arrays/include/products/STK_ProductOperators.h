...
template< typename, int, int, bool> class CArraySquare;
...
template<typename Type, int RStructure_> struct ProductArray2DReturnType<Type, Arrays::general_, RStructure_>
{ typedef Array2D<Type> result_type;};
template<typename Type> struct ProductArray2DReturnType<Type, Arrays::general_, Arrays::vector_>
{ typedef Array2DVector<Type> result_type;};
template<typename Type> struct ProductArray2DReturnType<Type, Arrays::general_, Arrays::point_>
{}; // not possible

template<typename Type> struct ProductArray2DReturnType<Type, Arrays::square_, Arrays::general_>
{ typedef Array2D<Type> result_type;};
...
template<typename Type> struct ProductArray2DReturnType<Type, Arrays::diagonal_, Arrays::general_>
{ typedef Array2D<Type> result_type;};
...
template<typename Type> struct ProductArray2DReturnType<Type, Arrays::point_, Arrays::general_>
...
struct ProductTraits<Lhs, Rhs, Arrays::general_, RStructure_>
...
template<typename Lhs, typename Rhs>
struct ProductTraits<Lhs, Rhs, Arrays::general_, Arrays::vector_>
        : public ProductTraitsBase<Lhs, Rhs>
{
  typedef ProductTraitsBase<Lhs, Rhs> Base;
  typedef typename hidden::Promote< typename Lhs::Type, typename Rhs::Type>::result_type Type;
        ...
        : public ProductTraitsBase<Lhs, Rhs>
{
  ...
  typedef typename hidden::Promote< typename Lhs::Type, typename Rhs::Type>::result_type Type;
  typedef typename ProductArray2DReturnType<Type, Lhs::structure_, Rhs::structure_>::result_type Result2D;
  typedef CArraySquare<Type ,Base::sizeRows_ , Base::sizeCols_, Base::orient_> CResult;
