...
int main(int argc, char *argv[])
{
  try
  {
    ...
    Chrono::start();
    CArrayNumber<Real, 1, 1, Arrays::by_col_> res;
    res = p1*v1;
    Real eps = res - p3.sum();
    ...
    CArrayVector<Real, 202, 1> r10; r10 = 10.0;
    Chrono::start();
    res2 = blhs * d10;
    ...
    stk_cout << _T("+++++++++++++++++++++++++++++++++++++++++++++++++++++++\n");
    CArrayVector<Real, 22, 1> cv1(22, 0.01);
    CVectorX cres;
    Chrono::start();
    ...
    CArrayPoint<Real, 1, 202> pv1(22, 0.01);
    CArrayPoint<Real, 1, 22> pres;
    Chrono::start();
