...
//    cdata.move(*ctrans.p_data());
    //    CArrayVector<Binary, UnknownSize, 1> cvar;
    //    BernoulliModel< CArrayVector<Binary, UnknownSize, 1> > ucModel;
    ...
    {
      stk_cout << "j=" << j << "\n";
      stk_cout << "jb.law().prob(j) = " << jb.p_param()->prob(j) << "\n";
