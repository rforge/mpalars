...
namespace HD
{
  ...
  class PenalizedModels : public STK::IModelBase
  {
    public:
      /**
       * Constructor
       ...
       *
       */
      PenalizedModels(STK::CArrayXX const* p_data, STK::CVectorX const& y, STK::CVectorX const& beta, IPenalty* p_penalty = 0, IPenalizedSolver* p_solver = 0, STK::Real threshold = STK::Arithmetic<STK::Real>::epsilon())
      ...
      inline void eStep()
      {
        ...
        if(p_penalty_ == 0)
        {
          ...
          //this->msg_error_ = STKERROR_NO_ARG(PenalizedModels::eStep(), a penalty has not be set);
      ...
      inline void mStep()
      {
        if(p_solver_ == 0)
        {
          ...
          //this->msg_error_ = STKERROR_NO_ARG(PenalizedModels::mStep(), a solver has not be set);
    ...
    protected:
      ...
      void updateCurrentData()
      {
        ...
        currentData_.resize(nbSample(),nbActiveVariables_);
    ...
    private:
      ...
      /// number of variables in the currentSet_
