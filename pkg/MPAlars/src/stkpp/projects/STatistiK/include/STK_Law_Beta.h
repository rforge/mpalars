...
class Beta : public IUnivLaw<Real>
{
  ...
  public:
    ...
    /**
     *  Generate a pseudo Beta random variate with the specified
     *  parameters.
     *  This function use the Gamma::rand() random generator.
     *  TODO : implement the order statistics when a and b
     *  are small integers (Devroye p. 431). 
    ...
    /**
     *  The cumulative distribution function is given by the incomplete
     *  Beta function.
     **/
    virtual Real cdf( const Real& t) const;
    
    /**
     * The inverse cumulative distribution function does not have
     * a close form.
     **/
