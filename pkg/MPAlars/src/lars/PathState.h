...
namespace MPA
{
  class PathState
  {
    public:
       ...
       * */
      inline void setCoefficients(STK::Array2DVector< std::pair<int,STK::Real> > const& coefficients){coefficients_=coefficients;}
      ...
      inline STK::Array2DVector< std::pair<int,STK::Real> > const& coefficients() const {return coefficients_;}
    ...
    private:
      //attributes
      STK::Array2DVector< std::pair<int,STK::Real> > coefficients_;
      STK::Real lambda_;
  };
}
